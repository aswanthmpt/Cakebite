...
class Product(models.Model):
    ...
    price_1kg=models.DecimalField(max_digits=10,decimal_places=2,blank=True,null=True)
    price_2kg=models.DecimalField(max_digits=10,decimal_places=2,blank=True,null=True)
    design_2price=models.DecimalField(max_digits=10,decimal_places=2,blank=True,null=True)
